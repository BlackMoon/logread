...
h1=e4.d3;
h3=e4.d4;
}while (!(ab0==h1&&ab1==h3)&&this.GetCellFromRowCol(e4,h1,h3).getAttribute("TabStop")!=null&&this.GetCellFromRowCol(e4,h1,h3).getAttribute("TabStop")=="false")
}
else {
this.MoveRight(e4,h1,h3);
}
...
var ab2=this.GetParent(this.GetViewport(e4));
...
ab2.scrollLeft=h4.offsetLeft+h4.offsetWidth-aa8.clientWidth;
}
}
...
ab2.scrollTop=h4.offsetTop+h4.offsetHeight-aa8.clientHeight;
}
if (h4.offsetTop<aa8.scrollTop){
ab2.scrollTop=h4.offsetTop;
}
this.ScrollView(e4);
this.EnableButtons(e4);
this.SaveData(e4);
...
var ab4=this.UpdateLeadingCell(e4,e4.d3,h3);
if (ab4)e4.d3=ab3;
}
...
var ab5=0;
if (e4.getAttribute("LayoutMode")){
ab5=this.GetRowFromViewPort(e4,h1,h3);
var ab6=this.GetCellFromRowCol(e4,ab5,h3);
if (ab6)ab5=ab6.parentNode.getAttribute("row");
}
var i3=this.FireActiveCellChangingEvent(e4,h1,h3,ab5);
if (!i3){
var o2=this.GetOperationMode(e4);
if (o2!="MultiSelect")
this.ClearSelection(e4);
...
var ab7=this.GetColHeader(e4);
if (ab7!=null&&ab7.rows.length>0){
f3=this.GetColGroup(ab7);
}else {
var e7=this.GetViewport(e4);
...
var ab8=e4.getAttribute("EnableRowEditTemplate");
return ab8;
}
this.GetSelectionPolicy=function (e4){
var ab9=e4.getAttribute("SelectionPolicy");
return ab9;
}
...
var ac0=(e4.getAttribute("ajax")!="false");
if (ac0){
...
var h5=e4.d5;
var h6=e4.d6;
var ac3=this.GetRowFromCell(e4,cl2);
var n0=0;
if (e4.d7=="r"){
n0=-1;
...
if (this.IsChild(cl2,this.GetColHeader(e4))){
ac3=0;n0=this.GetColFromCell(e4,cl2);
...
if (h9.row>ac3||h9.row+h9.rowCount-1<h5){
this.PaintSelection(e4,h9.row,h9.col,h9.rowCount,h9.colCount,false);
this.PaintSelection(e4,h5,h6,ac3-h5+1,n0-h6+1,true);
}else {
if (h5>h9.row){
var g0=h5-h9.row;
this.PaintSelection(e4,h9.row,h9.col,g0,h9.colCount,false);
if (ac3<h9.row+h9.rowCount-1){
this.PaintSelection(e4,ac3,h9.col,h9.row+h9.rowCount-ac3,h9.colCount,false);
}else {
this.PaintSelection(e4,h9.row+h9.rowCount,h9.col,ac3-h9.row-h9.rowCount+1,h9.colCount,true);
}
}else {
this.PaintSelection(e4,h5,h9.col,h9.row-h5,h9.colCount,true);
if (ac3<h9.row+h9.rowCount-1){
this.PaintSelection(e4,ac3+1,h9.col,h9.row+h9.rowCount-ac3-1,h9.colCount,false);
}else {
this.PaintSelection(e4,h9.row+h9.rowCount,h9.col,ac3-h9.row-h9.rowCount+1,h9.colCount,true);
}
}
...
this.ExtendSelection(e4,h9,h5,h6,ac3-h5+1,n0-h6+1);
}else {
this.PaintSelection(e4,h5,h6,ac3-h5+1,n0-h6+1,true);
}
this.SetSelection(e4,h5,h6,ac3-h5+1,n0-h6+1,h9==null);
}
...
var ac4=Math.min(h9.row+h9.rowCount-1,newRow+newRowCount-1);
if (h9.row<x2){
...
if (newRow+newRowCount-1>ac4){
this.PaintSelection(e4,ac4+1,newCol,newRow+newRowCount-ac4-1,newColCount,true);
}
...
var ac5=this.GetSelectedRange(e4);
if (h1<ac5.row||h1>=ac5.row+ac5.rowCount||h3<ac5.col||h3>=ac5.col+ac5.colCount)
return ;
}
}
...
this.RangeIntersection=function (h5,h6,y5,cc1,ac3,n0,rc2,cc2){
var ac6=this.LineIntersection(h5,y5,ac3,rc2);
var ac7=this.LineIntersection(h6,cc1,n0,cc2);
if (ac6&&ac7)
return {row:ac6.s,col:ac7.s,rowCount:ac6.c,colCount:ac7.c};
return null;
}
...
o1=o0.childNodes[f1];
if (o1){
ac3=parseInt(o1.getAttribute("rowIndex"));
n0=parseInt(o1.getAttribute("colIndex"));
ad1=parseInt(o1.getAttribute("rowcount"));
ad2=parseInt(o1.getAttribute("colcount"));
if (ac3<0||ad1<0){ac3=0;ad1=this.GetRowCountInternal(e4);}
if (n0<0||ad2<0){n0=0;ad2=this.GetColCount(e4);}
if (ad3<ad1)
ad3=ad1;
if (ad4<ad2)
ad4=ad2;
if (f1>=o0.childNodes.length-1){
if (h1<=ac3&&n6>=ad1||e4.getAttribute("LayoutMode")&&h0==1&&h1<parseInt(e4.getAttribute("layoutrowcount"))){
...
h9=this.RangeIntersection(h1,h3,n6,h0,ac3,n0,ad1,ad2);
if (h9){
this.PaintViewportSelection(e4,h9.row,h9.col,h9.rowCount,h9.colCount,true);
}
if (ac8){
ad5=this.LineIntersection(h3,h0,n0,ad2);
if (ad5)this.PaintHeaderSelection(e4,h1,ad5.s,n6,ad5.c,true,true);
}
if (ac9){
ad5=this.LineIntersection(h1,n6,ac3,ad1);
if (ad5)this.PaintHeaderSelection(e4,ad5.s,h3,ad5.c,h0,true,false);
}
}
}
}
...
if (u0!=null||u6!=null){
if ((ad3<n6&&u0<0)||(ad4<h0&&u6<0))
ad0=true;
}
if (o0.childNodes.length<=0||(e4.getAttribute("SelectionPolicy")=="MultiRange"&&ad0)){
...
if (g7==null)return ;
var ad6=this.GetSelectedRange(e4);
if (e4.d1==null&&(ad6==null||(ad6.rowCount==0&&ad6.colCount==0))){
g7.style.left="-1000px";
var v6=e4.id;
...
ad6=new this.Range();
this.SetRange(ad6,"Row",h1,-1,1,-1);
}else if (ad6==null||(ad6.rowCount==0&&ad6.colCount==0)){
var h1=e4.GetActiveRow();
var h3=e4.GetActiveCol();
ad6=new this.Range();
this.SetRange(ad6,"Cell",h1,h3,e4.d1.rowSpan,e4.d1.colSpan);
}
if (ad6.row<0){
ad6.row=0;
ad6.rowCount=this.GetRowCountInternal(e4);
}
if (ad6.col<0){
ad6.col=0;
ad6.colCount=this.GetColCount(e4);
if (e4.getAttribute("LayoutMode")&&ad6.rowCount<parseInt(e4.getAttribute("layoutrowcount"))&&ad6.type=="Row")ad6.rowCount=parseInt(e4.getAttribute("layoutrowcount"));
}
var u0;
if (e4.getAttribute("LayoutMode"))
u0=(ad6.innerRow!=null)?ad6.innerRow:ad6.row;
else 
u0=ad6.row;
var h4=this.GetCellFromRowCol(e4,u0,ad6.col);
if (h4==null)return ;
if (ad6.rowCount==1&&ad6.colCount==1){
ad6.rowCount=h4.rowSpan;
ad6.colCount=h4.colSpan;
if (h4.colSpan>1){
var ad7=parseInt(h4.getAttribute("col"));
if (ad7!=ad6.col&&!isNaN(ad7)&&!e4.getAttribute("LayoutMode"))ad6.col=ad7;
}
}
var g0=this.GetOffsetTop(e4,h4);
var ad8=this.GetOffsetLeft(e4,h4);
if (h4.rowSpan>1){
u0=h4.parentNode.rowIndex;
var h6=this.GetCellFromRowCol(e4,u0,ad6.col+ad6.colCount-1);
if (h6!=null&&h6.parentNode.rowIndex>h4.parentNode.rowIndex){
g0=this.GetOffsetTop(e4,h6);
}
if (e4.getAttribute("LayoutMode")&&ad6.rowCount<h4.rowSpan&&(ad6.type=="Column"||ad6.type=="Row"))ad6.rowCount=h4.rowSpan;
}
if (h4.colSpan>1){
var h6=this.GetCellFromRowCol(e4,u0+ad6.rowCount-1,ad6.col);
var q1=this.GetOffsetLeft(e4,h6);
if (q1>ad8){
ad8=q1;
h4=h6;
}
if (e4.getAttribute("LayoutMode")&&ad6.colCount<h4.colSpan&&(ad6.type=="Column"||ad6.type=="Row"))ad6.colCount=h4.colSpan;
}
var k0=0;
var g9=this.GetViewport(e4).rows;
for (var h1=u0;h1<u0+ad6.rowCount&&h1<g9.length;h1++){
...
for (var h3=ad6.col;h3<ad6.col+ad6.colCount&&h3<f3.childNodes.length;h3++){
j3+=f3.childNodes[h3].offsetWidth;
if (h3>ad6.col)j3+=parseInt(this.GetViewport(e4).cellSpacing);
}
if (ad6.col>h4.cellIndex&&ad6.type=="Column"){
var n0=(e4.getAttribute("LayoutMode")!=null)?parseInt(h4.getAttribute("scol")):parseInt(h4.getAttribute("col"));
for (var h3=n0;h3<ad6.col;h3++){
ad8+=f3.childNodes[h3].offsetWidth;
if (h3>n0)ad8+=parseInt(this.GetViewport(e4).cellSpacing);
}
}
if (ad6.row>0)g0-=2;
else k0-=2;
...
g7.style.left=""+(ad8+j3)+"px";
g7.style.top=""+g0+"px";
g7.style.height=""+k0+"px";
}
this.PaintCornerSelection=function (e4,select){
var ad9=true;
if (this.GetTopSpread(e4).getAttribute("ShowHeaderSelection")=="false")ad9=false;
if (!ad9)return ;
...
if (this.GetTopSpread(e4).getAttribute("ShowHeaderSelection")=="false")ad9=false;
if (!ad9)return ;
var ae0=c6?e4.e1:e4.e0;
if (e4.getAttribute("LayoutMode")&&c6){
if (n6>parseInt(e4.getAttribute("layoutrowcount")))
n6=parseInt(e4.getAttribute("layoutrowcount"));
var ae1=this.GetCellFromRowCol(e4,h1,h3);
if (e4.allowGroup&&ae1.getAttribute("group")!=null)
h1=this.GetFirstMultiRowFromViewport(e4,h1,true);
for (var f1=h1;f1<h1+n6;f1++){
for (var i1=h3;i1<h3+h0;i1++){
var ae2=this.GetCellFromRowCol(e4,f1,i1);
if (ae2){
var o3=this.GetRowTemplateRowFromCell(e4,ae2);
if (!isNaN(o3)){
...
for (var i1=h3;i1<h3+h0&&i1<t6;i1++){
if (!e4.getAttribute("LayoutMode")&&this.IsCovered(e4,f1,i1,ae0))continue ;
...
var x4=null;
if (h4!=null){
var ae3=this.GetRender(h4);
x4=this.GetValueFromRender(e4,ae3);
if (x4==null||x4==" ")x4="";
}
return x4;
}
...
var ae3=this.GetRender(h4);
var t1=this.GetCellType(h4);
if ((t1!="readonly"||ignoreLock)&&ae3!=null&&ae3.getAttribute("FpEditor")!="Button")
this.SetValueToRender(ae3,x4);
}
}
...
var ae4=h1;
var aa4=h3;
var ae5=new String(f6);
if (ae5.length==0)return ;
var f0=ae5.lastIndexOf("\r\n");
if (f0>=0&&f0==ae5.length-2)ae5=ae5.substring(0,f0);
var ae6=0;
var ae7=ae5.split("\r\n");
for (var f1=0;f1<ae7.length&&ae4<n6;f1++){
if (typeof(ae7[f1])=="string"){
ae7[f1]=ae7[f1].split("\t");
if (ae7[f1].length>ae6)ae6=ae7[f1].length;
}
ae4++;
}
ae4=this.GetSheetIndex(e4,h1);
for (var f1=0;f1<ae7.length&&ae4<n6;f1++){
var ae8=ae7[f1];
if (ae8!=null){
aa4=h3;
var h4=null;
var ac3=this.GetDisplayIndex(e4,ae4);
for (var i1=0;i1<ae8.length&&aa4<h0;i1++){
if (!this.IsCovered(e4,ac3,aa4,e4.d9)){
h4=this.GetCellFromRowCol(e4,ac3,aa4,h4);
if (h4==null)return ;
...
if (h4!=null&&h4.parentNode.getAttribute("previewrow")!=null)continue ;
var ae9=ae8[i1];
if (!this.ValidateCell(e4,h4,ae9)){
if (e4.getAttribute("lcidMsg")!=null)
alert(e4.getAttribute("lcidMsg"));
else 
alert("Can't set the data into the cell. The data type is not correct for the cell.");
...
var t1=this.GetCellType(h4);
var ae3=this.GetRender(h4);
if (t1!="readonly"&&ae3.getAttribute("FpEditor")!="Button"){
var ae9=null;
if (ae8!=null&&i1<ae8.length)ae9=ae8[i1];
this.SetCellValueFromView(h4,ae9);
if (ae9!=null){
this.SetCellValue(e4,h4,""+ae9);
}else {
...
if (!this.IsCovered(e4,f1,i1,e4.d9)){
h4=this.GetCellFromRowCol(e4,f1,i1,h4);
if (e4.getAttribute("LayoutMode")&&af0&&(h4==null||(h4.parentNode.getAttribute("row"))!=h1))continue ;
if (h4!=null&&h4.parentNode.getAttribute("previewrow")!=null)continue ;
var t1=this.GetCellType(h4);
if (t1!="readonly"){
var af1=this.GetEditor(h4);
if (af1!=null&&af1.getAttribute("FpEditor")=="Button")continue ;
...
if (af2!=null){
for (var h3=0;h3<af2.cells.length;h3++){
var af3=af2.cells[h3];
r6+=af3.offsetWidth;
if (m6<r6){
return af3;
}
...
var af4=parseInt(((g0-e4.slideLeft)/(e4.slideRight-e4.slideLeft))*n2)+1;
if (e4.style.position!="absolute"&&e4.style.position!="relative")
...
var af4=this.MoveSliderBar(e4,event);
var af5=this.GetElementById(this.activePager,e4.id+"_posIndicator");
af5.innerHTML=this.activePager.getAttribute("pageText")+af4;
}
return ;
}
...
var e7=this.GetViewport(e4);
var af6=document.body;
var af7=this.GetGroupBar(e4);
var g0=-1;
...
var af8=false;
var j9=this.IsXHTML(e4);
var af9=j9?document.body.parentNode.scrollTop:document.body.scrollTop;
var m7=document.getElementById(e4.id+"_titleBar");
if (m7)af9-=m7.parentNode.parentNode.offsetHeight;
if (this.GetPager1(e4)!=null)af9-=this.GetPager1(e4).offsetHeight;
if (af7!=null&&event.clientY<this.GetOffsetTop(e4,e4,document.body)-e7.parentNode.scrollTop+af7.offsetHeight-af9){
if (e4.style.position!="absolute"&&e4.style.position!="relative")
r6=this.GetOffsetLeft(e4,e4,document.body);
x2+=10;
af8=true;
var z5=af7.getElementsByTagName("TABLE")[0];
if (z5!=null){
...
if (af7!=null)x2+=af7.offsetHeight;
if (m6<r6){
g0=0;
}else {
var aa1=e4.selectedCols.context;
...
r6-=5;
var ag0=parseInt(this.GetSheetColIndex(e4,g0));
if (ag0<0)ag0=g0;
e4.targetCol=ag0;
}
if (m7)x2+=m7.parentNode.parentNode.offsetHeight;
if (this.GetPager1(e4)!=null)x2+=this.GetPager1(e4).offsetHeight;
var af5=this.GetPosIndicator(e4);
af5.style.left=""+r6+"px";
af5.style.top=""+x2+"px";
if (af7!=null&&af8&&af7.getElementsByTagName("TABLE").length==0){
af5.style.display="none";
}else {
if (af8||e4.allowColMove)
af5.style.display="";
else 
af5.style.display="none";
}
var i6=this.GetParent(this.GetViewport(e4));
if (i6!=null){
var ag1=this.GetOffsetLeft(e4,e4,document.body)+i6.offsetLeft+i6.offsetWidth-20;
var ag2=0;
var m3=this.GetViewport2(e4);
if (m3!=null){
ag2=m3.offsetWidth;
...
if (event.clientX>ag1){
i6.scrollLeft=i6.scrollLeft+10;
this.ScrollView(e4);
this.UpdatePostbackData(e4);
}else if (event.clientX<this.GetOffsetLeft(e4,e4,document.body)+i6.offsetLeft+ag2+5){
i6.scrollLeft=i6.scrollLeft-10;
this.ScrollView(e4);
this.UpdatePostbackData(e4);
}
...
var m2=this.GetViewport1(e4);
if (m2!=null){
ag3=this.GetViewport1(e4).offsetHeight;
t4+=ag3;
}
if (event.clientY>t4){
i6.scrollTop=i6.scrollTop+10;
this.ScrollView(e4);
}else if (event.clientY<this.GetOffsetTop(e4,e4,document.body)+i6.offsetTop+ag3+5){
i6.scrollTop=i6.scrollTop-10;
this.ScrollView(e4);
}
var ag1=this.GetOffsetLeft(e4,e4,document.body)+i6.offsetLeft+i6.offsetWidth-20;
...
var ag4=event.clientX-this.b6;
var aa2=parseInt(this.b4.width)+ag4;
var x1=0;
var ag5=(aa2>x1);
if (ag5){
if (e4.frzRows>0||e4.frzCols>0){
...
var ag4=event.clientY-this.b7;
var ag6=parseInt(this.b5.style.height)+ag4;
var x1=0;
var ag5=(x1<ag6);
if (ag5){
if (e4.frzRows>0||e4.frzCols>0){
...
this.b5.style.height=""+(parseInt(this.b5.style.height)+ag4)+"px";
...
var ad8=Math.max(10,(j3-parseInt(i3.style.width))/2);
var g0=Math.max(10,(k0-parseInt(i3.style.height))/2);
if (e4.style.position!="absolute"&&e4.style.position!="relative"){
ad8+=this.GetOffsetLeft(e4,e4,document.body);
g0+=this.GetOffsetTop(e4,e4,document.body);
}
i3.style.top=""+g0+"px";
i3.style.left=""+ad8+"px";
...
var ag7=this.GetPageActiveSpread();
if (this.GetViewport(e4)==null)return ;
...
this.b8=p1;
if (e4.frzRows>0||e4.frzCols>0){
var ag9=this.GetViewport0(e4);
if (ag9==null)ag9=this.GetViewport1(e4);
if (ag9==null)ag9=this.GetViewport(e4);
ag9=ag9.parentNode;
if (this.GetColHeader(e4)!=null)
e4.sizeBar.style.top=""+(this.GetOffsetTop(e4,ag9,e4)-this.GetColHeader(e4).offsetHeight)+"px";
else 
e4.sizeBar.style.top=""+this.GetOffsetTop(e4,ag9,e4)+"px";
var h7=0;
if (!j9)h7+=parseInt(e4.style.borderWidth);
e4.sizeBar.style.left=(this.b6-this.GetOffsetLeft(e4,e4,document.body)-h7+window.scrollX)+"px";
var ah0=0;
if (this.GetViewport0(e4)!=null)ah0=this.GetViewport0(e4).parentNode.offsetHeight;
if (ah0==0&&this.GetViewport1(e4)!=null)ah0=this.GetViewport1(e4).parentNode.offsetHeight;
if (this.GetViewport(e4)!=null)ah0+=this.GetViewport(e4).parentNode.offsetHeight;
if (this.GetColHeader(e4)!=null)ah0+=this.GetColHeader(e4).offsetHeight;
e4.sizeBar.style.height=""+ah0+"px";
e4.sizeBar.style.width="2px";
}
}else {
...
var ah1=this.GetCell(p1,null,event);
if (ah1==null){
var c4=this.GetCorner(e4);
...
var ah2=this.GetColFromCell(e4,ah1);
if (ah1.parentNode.getAttribute("FpSpread")=="ch"&&ah2>=this.GetColCount(e4))return ;
if (ah1.parentNode.getAttribute("FpSpread")=="rh"&&this.IsChildSpreadRow(e4,this.GetViewport(e4),ah1.parentNode.rowIndex))return ;
if (ah1.parentNode.getAttribute("FpSpread")=="ch"&&this.GetOperationMode(e4)!="Normal"){
if (e4.allowColMove||e4.allowGroup){
if (e4.getAttribute("LayoutMode"))ah2=parseInt(ah1.getAttribute("col"));
this.InitMovingCol(e4,ah2);
}
this.a6=true;
this.b8=p1;
return this.CancelDefault(event);
}
if (ah1.parentNode.getAttribute("FpSpread")=="ch"&&(this.GetOperationMode(e4)=="RowMode"||this.GetOperationMode(e4)=="SingleSelect"||this.GetOperationMode(e4)=="ExtendedSelect")){
if (!e4.allowColMove&&!e4.allowGroup)
return ;
}else {
var p2=this.FireActiveCellChangingEvent(e4,this.GetRowFromCell(e4,ah1),ah2,ah1.parentNode.getAttribute("row"));
if (p2)return ;
var o2=this.GetOperationMode(e4);
var e9=this.GetTopSpread(e4);
...
if (o2!="MultiSelect"){
if (!(
(e4.allowColMove||e4.allowGroup)&&ah1.parentNode.getAttribute("FpSpread")=="ch"&&
o2=="Normal"&&(e4.getAttribute("SelectionPolicy")=="Range"||e4.getAttribute("SelectionPolicy")=="MultiRange")&&
e4.selectedCols.length!=0&&this.IsColSelected(e4,ah2)
))
this.ClearSelection(e4);
}
}else {
...
if (ah1.parentNode.getAttribute("FpSpread")!="ch")this.SetActiveRow(e4,this.GetRowKeyFromCell(e4,e4.d1));
if (ah1.parentNode.getAttribute("FpSpread")=="rh")
...
if (o2=="ExtendedSelect"||o2=="MultiSelect"){
var ah3=this.IsRowSelected(e4,this.GetRowFromCell(e4,e4.d1));
if (ah3)
...
this.SelectRange(e4,this.GetRowFromCell(e4,e4.d1),ah2,1,1,true);
}
...
var ah4=v8=="ReadOnly"||v8=="SingleSelect"||t1=="readonly";
if (!ah4){
ah4=this.AnyReadOnlyCell(e4,o1);
}
if (ah4){
...
if (f9.tagName=="IMG"){
var ah5=f9.getAttribute("disabledImg");
if (disabled&&ah5!=null&&ah5!=""){
if (f9.src.indexOf(ah5)<0)f9.src=ah5;
}else {
var ah6=f9.getAttribute("enabledImg");
...
this.dragSlideBar=false;
if (this.activePager!=null){
var af4=this.MoveSliderBar(e4,event)-1;
this.activePager=null;
this.GotoPage(e4,af4);
}
return ;
}
...
this.a6=false;
if (this.dragCol!=null&&this.dragCol>=0){
var ah7=(this.IsChild(p1,this.GetGroupBar(e4))||p1==this.GetGroupBar(e4));
if (!ah7&&this.GetGroupBar(e4)!=null){
var ah8=event.clientX;
var ah9=event.clientY;
var r6=this.GetOffsetLeft(e4,e4,document.body);
var x2=this.GetOffsetTop(e4,e4,document.body);
var ai0=this.GetGroupBar(e4).offsetWidth;
var ai1=this.GetGroupBar(e4).offsetHeight;
...
ah7=(r6<=r1+ah8&&r1+ah8<=r6+ai0&&x2<=r0+ah9&&r0+ah9<=x2+ai1);
}
...
ai2=parseInt(v0.childNodes[k4-e4.frzCols].width);
else 
ai2=parseInt(v0.childNodes[k4].width);
}else {
ai2=1;
}
if (this.GetViewport(e4).rules!="rows"){
if (k4==parseInt(this.colCount)-1)ai2-=1;
}
if (aa2!=ai2&&event.clientX!=this.b7)
{
this.SetColWidth(e4,k4,aa2,ai2);
...
i3=false;
var ag4=event.clientY-this.b7;
var ag6=this.b5.offsetHeight+ag4;
if (ag6<1){
ag6=1;
ag4=1-this.b5.offsetHeight;
}
this.b5.style.height=""+ag6+"px";
...
var ai3=this.GetViewport2(e4);
if (this.IsChild(this.b5,this.GetFrozRowHeader(e4))){
ai3=this.GetViewport0(e4);
}
if (ai3!=null)
ai3.rows[this.b5.rowIndex].style.height=i6.rows[this.b5.rowIndex].style.height;
if (this.IsChild(this.b5,this.GetFrozRowHeader(e4))){
this.GetFrozRowHeader(e4).parentNode.parentNode.parentNode.style.posHeight+=ag4;
}
...
var ai5=this.GetParentSpread(i8);
if (ai5!=null)
this.UpdateRowHeight(ai5,i8);
}
...
var ai6=this.GetEditor(this.a8);
i4=(ai6!=null);
}
...
var ai7=eval(this.a8.getAttribute("MccbId")+"_Obj");
if (event.altKey&&event.keyCode==event.DOM_VK_DOWN)return ;
if (ai7!=null&&ai7.getIsDrop!=null&&ai7.getIsDrop())return ;
}
switch (event.keyCode){
case event.DOM_VK_LEFT:
case event.DOM_VK_RIGHT:
if (i4){
var ai8=this.a8.getAttribute("FpEditor");
if (this.a7&&ai8=="ExtenderEditor"){
var ai9=FpExtender.Util.getEditor(this.a8);
if (ai9&&ai9.type!="text")this.EndEdit();
}
if (ai8!="RadioButton"&&ai8!="ExtenderEditor")this.EndEdit();
}
if (!this.a7){
...
var aj0=this.a8.getAttribute("Extenders");
if (aj0&&aj0.indexOf("AutoCompleteExtender")!=-1)return ;
}
...
var p3=this.GetProcessTab(e4);
var aj1=(p3=="true"||p3=="True");
if (aj1)this.NextCell(e4,event,event.keyCode);
break ;
...
var ab9=new RegExp("\\s*");
var aj2=new RegExp("\\S*");
...
var aj4=[];
for (var f1=0;f1<e4.selectedCols.length;f1++)
aj4[f1]=this.GetSheetColIndex(e4,e4.selectedCols[f1]);
var aj5=aj4.join("+");
this.MoveMultiCol(e4,aj5,to);
return ;
}
var ac0=(e4.getAttribute("ajax")!="false");
if (ac0)
...
this.MoveMultiCol=function (e4,aj5,to){
var v6=e4.getAttribute("name");
var ac0=(e4.getAttribute("ajax")!="false");
if (ac0)
this.SyncData(v6,"MoveCol,"+aj5+","+to,e4);
else 
__doPostBack(v6,"MoveCol,"+aj5+","+to);
}
...
for (var f1=0;f1<e4.selectedCols.length;f1++)
if (e4.getAttribute("LayoutMode"))
aj4[f1]=parseInt(e4.selectedCols[f1]);
else 
aj4[f1]=this.GetSheetColIndex(e4,e4.selectedCols[f1]);
var aj5=aj4.join("+");
this.GroupMultiCol(e4,aj5,toCol);
e4.selectedCols=[];
return ;
}
var ac0=(e4.getAttribute("ajax")!="false");
...
this.GroupMultiCol=function (e4,aj5,toCol){
var v6=e4.getAttribute("name");
var ac0=(e4.getAttribute("ajax")!="false");
if (ac0)
this.SyncData(v6,"Group,"+aj5+","+toCol,e4);
else 
__doPostBack(v6,"Group,"+aj5+","+toCol);
}
...
try {
var aj6=this;
aj6.removeEventListener("load",the_fpSpread.ProcessData,false);
var p1=window.srcfpspread;
p1=p1.split(":").join("_");
var aj7=window.fpcommand;
var aj8=document;
var aj9=aj8.getElementById(p1+"_buff");
if (aj9==null){
aj9=aj8.createElement("iframe");
aj9.id=p1+"_buff";
aj9.style.display="none";
aj8.body.appendChild(aj9);
}
var e4=aj8.getElementById(p1);
the_fpSpread.CloseWaitMsg(e4);
if (aj9==null)return ;
var ak0=aj6.responseText;
aj9.contentWindow.document.body.innerHTML=ak0;
var p3=aj9.contentWindow.document.getElementById(p1+"_values");
if (p3!=null){
...
var ac2=the_fpSpread.GetValue(e4,h1,h3);
if (o1.innerHTML!=ac2){
...
the_fpSpread.UpdateSpread(aj8,aj9,p1,ak0,aj7);
}
var ac1=the_fpSpread.GetForm(e4);
ac1.__EVENTTARGET.value="";
ac1.__EVENTARGUMENT.value="";
var ac2=aj8.getElementsByName("__VIEWSTATE")[0];
var g0=aj9.contentWindow.document.getElementsByName("__VIEWSTATE")[0];
if (ac2!=null&&g0!=null)ac2.value=g0.value;
ac2=aj8.getElementsByName("__EVENTVALIDATION");
g0=aj9.contentWindow.document.getElementsByName("__EVENTVALIDATION");
if (ac2!=null&&g0!=null&&ac2.length>0&&g0.length>0)
ac2[0].value=g0[0].value;
aj9.contentWindow.document.location="about:blank";
...
var e4=the_fpSpread.GetTopSpread(aj8.getElementById(p1));
var g3=the_fpSpread.CreateEvent("CallBackStopped");
g3.command=aj7;
the_fpSpread.FireEvent(e4,g3);
};
this.UpdateSpread=function (aj8,aj9,p1,ak0,aj7){
var e4=the_fpSpread.GetTopSpread(aj8.getElementById(p1));
var t2=aj9.contentWindow.document.getElementById(e4.id);
if (t2!=null){
if (typeof(Sys)!=='undefined'){
FarPoint.System.ExtenderHelper.saveLoadedExtenderScripts(e4);
}
the_fpSpread.error=(t2.getAttribute("error")=="true");
if (aj7=="LoadOnDemand"&&!the_fpSpread.error){
var ak1=this.GetElementById(e4,e4.id+"_data");
var ak2=this.GetElementById(t2,e4.id+"_data");
if (ak1!=null&&ak2!=null)ak1.setAttribute("data",ak2.getAttribute("data"));
var ak3=t2.getElementsByTagName("style");
if (ak3!=null){
for (var f1=0;f1<ak3.length;f1++){
if (ak3[f1]!=null&&ak3[f1].innerHTML!=null&&ak3[f1].innerHTML.indexOf(e4.id+"msgStyle")<0)
e4.appendChild(ak3[f1].cloneNode(true));
}
}
var ak4=this.GetElementById(e4,e4.id+"_LoadInfo");
var ak5=this.GetElementById(t2,e4.id+"_LoadInfo");
if (ak4!=null&&ak5!=null)ak4.value=ak5.value;
var ak6=false;
var ak7=this.GetElementById(t2,e4.id+"_rowHeader");
if (ak7!=null){
ak7=ak7.firstChild;
ak6=(ak7.rows.length>1);
var j8=this.GetRowHeader(e4);
this.LoadRows(j8,ak7,true);
}
var ak8=this.GetElementById(t2,e4.id+"_viewport2");
if (ak8!=null){
ak6=(ak8.rows.length>0);
var e7=this.GetViewport2(e4);
this.LoadRows(e7,ak8,false);
}
ak8=this.GetElementById(t2,e4.id+"_viewport");
if (ak8!=null){
ak6=(ak8.rows.length>0);
var e7=this.GetViewport(e4);
this.LoadRows(e7,ak8,false);
...
if (typeof(Sys)!=='undefined'){
FarPoint.System.ExtenderHelper.loadExtenderScripts(e4,aj9.contentWindow.document);
}
}else {
...
var ak9=aj9.contentWindow.document.getElementById(e4.id+"_initScript");
eval(ak9.value);
}
}else {
the_fpSpread.error=true;
var al0=e4.getAttribute("errorPage");
if (al0!=null&&al0.length>0){
window.location.href=al0;
}
}
}
this.LoadRows=function (e7,ak8,isHeader){
if (e7==null||ak8==null)return ;
var al1=e7.tBodies[0];
var u5=ak8.rows.length;
var al2=null;
if (isHeader){
u5--;
if (al1.rows.length>0)al2=al1.rows[al1.rows.length-1];
}
for (var f1=0;f1<u5;f1++){
var al3=ak8.rows[f1].cloneNode(false);
al1.insertBefore(al3,al2);
al3.innerHTML=ak8.rows[f1].innerHTML;
}
if (!isHeader){
for (var f1=0;f1<ak8.parentNode.childNodes.length;f1++){
var ab7=ak8.parentNode.childNodes[f1];
if (ab7!=ak8){
e7.parentNode.insertBefore(ab7.cloneNode(true),null);
}
}
}
}
this.CopySpreadAttr=function (u1,dest,attrName){
var al4=u1.getAttribute(attrName);
var al5=dest.getAttribute(attrName);
if (al4!=null||al5!=null){
if (al4==null)
dest.removeAttribute(attrName);
else 
dest.setAttribute(attrName,al4);
}
}
...
this.SyncData=function (v6,aj7,e4,asyncCallBack){
...
if (aj7!=null&&(aj7.indexOf("SelectView,")==0||aj7=="Next"||aj7=="Prev"||aj7.indexOf("Group,")==0||aj7.indexOf("Page,")==0))
e4.LoadState=null;
var al6=g3.async;
if (al6){
this.OpenWaitMsg(e4);
...
if (this.error)aj7="update";
try {
var ac1=this.GetForm(e4);
if (ac1==null)return ;
ac1.__EVENTTARGET.value=v6;
ac1.__EVENTARGUMENT.value=encodeURIComponent(aj7);
var al7=ac1.action;
var g0;
if (al7.indexOf("?")>-1){
g0="&";
...
var ak0="";
var aj6=(window.XMLHttpRequest)?new XMLHttpRequest():new ActiveXObject("Microsoft.XMLHTTP");
if (aj6==null)return ;
aj6.open("POST",al7,al6);
aj6.setRequestHeader("Content-Type","application/x-www-form-urlencoded");
if (e4!=null)
window.srcfpspread=e4.id;
else 
window.srcfpspread=v6;
window.fpcommand=aj7;
this.AttachEvent(aj6,"load",the_fpSpread.ProcessData,false);
aj6.send(f6);
}catch (g3){
...
for (var f1=0;f1<ac1.elements.length;f1++){
g0=ac1.elements[f1];
var al8=g0.tagName.toLowerCase();
if (al8=="input"){
var al9=g0.type;
if (al9=="hidden"||al9=="text"||al9=="password"||((al9=="checkbox"||al9=="radio")&&g0.checked)){
...
var f6=this.GetData(e4);
var am0=f6.getElementsByTagName("root")[0];
var f7=am0.getElementsByTagName("data")[0];
if (f7==null)return null;
if (e4.d8!=null){
var i9=e4.d8.firstChild;
while (i9!=null){
var h1=i9.getAttribute("key");
var am1=i9.firstChild;
while (am1!=null){
var h3=am1.getAttribute("key");
var am2=f7.firstChild;
while (am2!=null){
var h5=am2.getAttribute("key");
if (h1==h5){
var am3=false;
var am4=am2.firstChild;
while (am4!=null){
var h6=am4.getAttribute("key");
if (h3==h6){
am2.removeChild(am4);
am3=true;
break ;
...
var f6=this.GetData(e4);
var f7=f6.getElementsByTagName("root")[0];
var ae9=f7.getElementsByTagName("data")[0];
if (ae9!=null)e4.d8=ae9.cloneNode(true);
}
...
var am5=this.GetMsgObj(e4,i9,n9);
if (am5&&am5.msgBox.IsVisible){
am5.msgBox.Hide();
}
}
...
am5=this.CreateMsgObj(e4,i9,n9);
var am6=am5.msgBox;
am6.Show(e4,this,x7);
if (time&&time>0)
am5.timer=setTimeout(function (){am6.Hide();},time);
this.SetMsgObj(e4,am5);
}
...
this.SetMsgObj=function (e4,am5){
var am7=e4.msgList;
if (am5.row==-1&&am5.col==-1)
am7.centerMsg=am5;
else if (am5.row==-2)
am7.hScrollMsg=am5;
else if (am5.col==-2)
...
if (!am7[am5.row])am7[am5.row]=new Array();
am7[am5.row][am5.col]=am5;
}
}
var am8=null;
this.CreateMsgObj=function (e4,i9,n9){
var am6=document.createElement("div");
var am5={row:i9,col:n9,msgBox:am6};
var am9=null;
if (i9!=-2&&n9!=-2){
am6.style.border="1px solid black";
am6.style.background="yellow";
am6.style.color="red";
}
else {
am6.style.border="1px solid #55678e";
am6.style.fontSize="small";
am6.style.background="#E6E9ED";
am6.style.color="#4c5b7f";
this.GetScrollingContentStyle(e4);
am9=am8;
}
if (am9!=null){
if (am9.fontFamily!=null)
am6.style.fontFamily=am9.fontFamily;
if (am9.fontSize!=null)
am6.style.fontSize=am9.fontSize;
if (am9.fontStyle!=null)
am6.style.fontStyle=am9.fontStyle;
if (am9.fontVariant!=null)
am6.style.fontVariant=am9.fontVariant;
if (am9.fontWeight!=null)
am6.style.fontWeight=am9.fontWeight;
if (am9.backgroundColor!=null)
am6.style.backgroundColor=am9.backgroundColor;
if (am9.color!=null)
am6.style.color=am9.color;
}
am6.style.position="absolute";
am6.style.overflow="hidden";
am6.style.display="block";
am6.style.marginLeft=0;
am6.style.marginTop=2;
am6.style.marginRight=0;
am6.style.marginBottom=0;
am6.msgObj=am5;
am6.Show=function (t2,fpObj,x7){
var z0=fpObj.GetMsgPos(t2,this.msgObj.row,this.msgObj.col);
var e8=fpObj.GetCommandBar(t2);
var an0=fpObj.GetGroupBar(t2);
...
var an1=(n5||f4||y0);
var an2=(t2.style.position=="relative"||t2.style.position=="absolute");
var an3=z0.top;
var an4=z0.left;
...
if (!an2&&an1&&r4){
var an5=fpObj.GetLocation(t2);
var an6=fpObj.GetLocation(r4);
an3+=an5.y-an6.y;
an4+=an5.x-an6.x;
if (r4.tagName!=="BODY"){
an3-=fpObj.GetBorderWidth(r4,0);
an4-=fpObj.GetBorderWidth(r4,3);
}
}
var an7=fpObj.GetViewPortByRowCol(t2,this.msgObj.row,this.msgObj.col);
if (!this.parentNode&&an7&&an7.parentNode)an7.parentNode.insertBefore(am6,null);
var j3=this.offsetWidth;
this.style.left=""+an4+"px";
if (!an1&&an7&&an7.parentNode&&an4+j3>an7.offsetWidth)
this.style.width=""+(z0.a5-2)+"px";
else if (parseInt(this.style.width)!=j3)
this.style.width=""+(j3-2)+"px";
if (!an1&&an7!=null&&an3>=an7.offsetHeight-2)an3-=z0.a4+this.offsetHeight;
this.style.top=""+an3+"px";
}
else {
if (!an2&&r4){
var an5=fpObj.GetLocation(t2);
...
var an8=20;
if (!this.parentNode)t2.insertBefore(am6,null);
if (this.offsetWidth+an8<t2.offsetWidth)
an4+=(t2.offsetWidth-this.offsetWidth-an8)/(this.msgObj.row==-2?1:2);
else 
this.style.width=""+(t2.offsetWidth-an8)+"px";
if (this.offsetHeight<t2.offsetHeight)
an3+=(t2.offsetHeight-this.offsetHeight)/(this.msgObj.col==-2?1:2);
if (this.msgObj.col==-2){
var an9=fpObj.GetColFooter(t2);
if (an9)an3-=an9.offsetHeight;
var e8=fpObj.GetCommandBar(t2);
if (e8)an3-=e8.offsetHeight;
an3-=an8;
}
this.style.top=""+an3+"px";
this.style.left=""+an4+"px";
...
var ao3=null;
var ao4=null;
for (var i8=ele;i8;ao2=i8,ao3=ao4,i8=i8.offsetParent){
var al8=i8.tagName;
ao4=this.GetCurrentStyle2(i8);
if ((i8.offsetLeft||i8.offsetTop)&&
!((al8==="BODY")&&
(!ao3||ao3.position!=="absolute"))){
ao0+=i8.offsetLeft;
ao1+=i8.offsetTop;
}
if (ao2!==null&&ao4){
if ((al8!=="TABLE")&&(al8!=="TD")&&(al8!=="HTML")){
ao0+=parseInt(ao4.borderLeftWidth)||0;
ao1+=parseInt(ao4.borderTopWidth)||0;
}
if (al8==="TABLE"&&
(ao4.position==="relative"||ao4.position==="absolute")){
ao0+=parseInt(ao4.marginLeft)||0;
ao1+=parseInt(ao4.marginTop)||0;
}
}
}
ao4=this.GetCurrentStyle2(ele);
var ao5=ao4?ao4.position:null;
if (!ao5||(ao5!=="absolute")){
for (var i8=ele.parentNode;i8;i8=i8.parentNode){
al8=i8.tagName;
if ((al8!=="BODY")&&(al8!=="HTML")&&(i8.scrollLeft||i8.scrollTop)){
ao0-=(i8.scrollLeft||0);
ao1-=(i8.scrollTop||0);
ao4=this.GetCurrentStyle2(i8);
if (ao4){
...
var ao6=["borderTopWidth","borderRightWidth","borderBottomWidth","borderLeftWidth"];
var ao7=["borderTopStyle","borderRightStyle","borderBottomStyle","borderLeftStyle"];
var ao8;
this.GetBorderWidth=function (ele,side){
if (!this.GetBorderVisible(ele,side))return 0;
var n7=this.GetCurrentStyle(ele,ao6[side]);
return this.ParseBorderWidth(n7);
}
this.GetBorderVisible=function (ele,side){
return this.GetCurrentStyle(ele,ao7[side])!="none";
}
this.GetWindow=function (ele){
var aj8=ele.ownerDocument||ele.document||ele;
return aj8.defaultView||aj8.parentWindow;
}
...
var ao9=(j3&&(ele!==j3))?j3.getComputedStyle(ele,null):ele.style;
return ao9;
}
...
if (ele){
if (ele.currentStyle){
ap0=ele.currentStyle[attribute];
}
else if (document.defaultView&&document.defaultView.getComputedStyle){
var ap1=document.defaultView.getComputedStyle(ele,null);
if (ap1){
ap0=ap1[attribute];
}
}
if (!ap0&&ele.style.getPropertyValue){
ap0=ele.style.getPropertyValue(attribute);
}
else if (!ap0&&ele.style.getAttribute){
ap0=ele.style.getAttribute(attribute);
}
}
if (!ap0||ap0==""||typeof(ap0)==='undefined'){
...
if (!ao8){
var ap2={};
var ap3=document.createElement('div');
ap3.style.visibility='hidden';
ap3.style.position='absolute';
ap3.style.fontSize='1px';
document.body.appendChild(ap3)
var ap4=document.createElement('div');
ap4.style.height='0px';
ap4.style.overflow='hidden';
ap3.appendChild(ap4);
var ap5=ap3.offsetHeight;
ap4.style.borderTop='solid black';
ap4.style.borderTopWidth='thin';
ap2['thin']=ap3.offsetHeight-ap5;
ap4.style.borderTopWidth='medium';
ap2['medium']=ap3.offsetHeight-ap5;
ap4.style.borderTopWidth='thick';
ap2['thick']=ap3.offsetHeight-ap5;
ap3.removeChild(ap4);
document.body.removeChild(ap3);
ao8=ap2;
}
if (n7){
switch (n7){
...
var ad8=n7.length;
var t2=-1;
for (var f1=0;f1<ad8;f1++){
var ab7=n7.substr(f1,1);
if ((ab7<'0'||ab7>'9')&&ab7!='-'&&ab7!='.'&&ab7!=',')
break ;
t2=f1;
}
if (t2==-1)
...
var ap7;
if (t2<(ad8-1))
al9=this.Trim(n7.substring(t2+1));
else 
al9='px';
ap7=parseFloat(n7.substr(0,t2+1));
if (al9=='px'){
ap7=Math.floor(ap7);
}
return {size:ap7,type:al9};
}
...
var y0=this.GetViewport2(e4);
var n7=this.GetViewport(e4);
var ap8=this.GetGroupBar(e4);
var m7=document.getElementById(e4.id+"_titleBar");
var h4=this.GetCellByRowCol(e4,i9,n9);
var g0=h4.offsetTop+h4.clientHeight;
var ad8=h4.offsetLeft;
...
var ap9=o4.getElementsByTagName("cellinfo")[0];
if (ap9==null)return null;
var g0=ap9.firstChild;
while (g0!=null){
...
{
var aq0=this.GetCellByRowCol(e4,h1,h3);
if (aq0){
aq0.GetValue=function (){
return the_fpSpread.GetValue(e4,h1,h3);
}
aq0.SetValue=function (value){
...
aq0.SetBackColor=function (value){
if (typeof(value)=="undefined")return ;
this.bgColor=value;
...
aq0.GetForeColor=function (){
return document.defaultView.getComputedStyle(this,"").getPropertyValue("color");
}
aq0.SetForeColor=function (value){
if (typeof(value)=="undefined")return ;
this.style.color=value;
the_fpSpread.setCellAttribute(e4,this,"fc",value);
the_fpSpread.SaveClientEditedDataRealTime();
}
aq0.GetTabStop=function (){
return this.getAttribute("TabStop")!="false";
}
aq0.SetTabStop=function (value){
if (typeof(value)=="undefined")return ;
var aq1=new String(value);
if (aq1.toLocaleLowerCase()=="false"){
...
aq0.GetCellType=function (){
var aq2=the_fpSpread.GetCellType2(this);
if (aq2=="text"||aq2=="readonly")
{
aq2=this.getAttribute("CellType2");
}
if (aq2==null)
aq2="GeneralCellType";
return aq2;
}
aq0.GetHAlign=function (){
var aq3=document.defaultView.getComputedStyle(this,"").getPropertyValue("text-Align");
if (aq3==""||aq3=="undefined"||aq3==null){
aq3=this.style.textAlign;
}
if (aq3==""||aq3=="undefined"||aq3==null)
aq3=this.getAttribute("align");
if (aq3=="start")aq3="left";
if (aq3!=null&&aq3.indexOf("-moz")!=-1)aq3=aq3.replace("-moz-","");
return aq3;
}
aq0.SetHAlign=function (value){
if (typeof(value)=="undefined")return ;
...
aq0.GetVAlign=function (){
var aq4=document.defaultView.getComputedStyle(this,"").getPropertyValue("vertical-Align");
if (aq4==""||aq4=="undefined"||aq4==null)
aq4=this.style.verticalAlign;
if (aq4==""||aq4=="undefined"||aq4==null)
aq4=this.getAttribute("valign");
return aq4;
}
aq0.SetVAlign=function (value){
if (typeof(value)=="undefined")return ;
...
aq0.GetLocked=function (){
if (aq0.GetCellType()=="ButtonCellType"||aq0.GetCellType()=="TagCloudCellType"||aq0.GetCellType()=="HyperLinkCellType")
return aq0.getAttribute("Locked")=="1";
return the_fpSpread.GetCellType(this)=="readonly";
}
aq0.GetFont_Name=function (){
return document.defaultView.getComputedStyle(this,"").getPropertyValue("font-family");
}
aq0.SetFont_Name=function (value){
if (typeof(value)=="undefined")return ;
this.style.fontFamily=value;
the_fpSpread.setCellAttribute(e4,this,"fn",value);
the_fpSpread.SaveClientEditedDataRealTime();
}
aq0.GetFont_Size=function (){
return document.defaultView.getComputedStyle(this,"").getPropertyValue("font-size");
}
aq0.SetFont_Size=function (value){
if (typeof(value)=="undefined")return ;
...
h1=parseInt(h1);
if (h1<0)return ;
var aq6=this.AddRowInfo(e4,h1);
aq6.setAttribute(attname,x4);
var f9=this.GetCmdBtn(e4,"Update");
if (f9!=null&&f9.getAttribute("disabled")!=null)
this.UpdateCmdBtnState(f9,false);
f9=this.GetCmdBtn(e4,"Cancel");
...
{
var aq7=this.getDomRow(e4,h1);
if (aq7){
aq7.GetHeight=function (){
return the_fpSpread.GetRowHeightInternal(e4,h1);
}
aq7.SetHeight=function (value){
if (typeof(value)=="undefined")return ;
...
h3=parseInt(h3);
if (h3<0)return ;
var aq8=this.AddColInfo(e4,h3);
aq8.setAttribute(attname,x4);
var f9=this.GetCmdBtn(e4,"Update");
if (f9!=null&&f9.getAttribute("disabled")!=null)
this.UpdateCmdBtnState(f9,false);
f9=this.GetCmdBtn(e4,"Cancel");
...
{
var aq9={a2:this.GetColByKey(e4,parseInt(h3))};
if (aq9){
aq9.GetWidth=function (){
return the_fpSpread.GetColWidthFromCol(e4,h3);
}
aq9.SetWidth=function (value){
if (typeof(value)=="undefined")return ;
...
var ar0=document.getElementById(e4.id+"_titleBar");
if (ar0!=null)ar0=document.getElementById(e4.id+"_title");
return ar0;
}
catch (ex){
return null;
...
var f7=f6.getElementsByTagName("root")[0];
if (f7==null)return null;
var ar1=f7.getElementsByTagName("titleinfo")[0];
if (ar1==null)return null;
return ar1;
}
...
var ar2=this.AddTitleInfo(e4);
ar2.setAttribute(attname,x4);
var f9=this.GetCmdBtn(e4,"Update");
if (f9!=null&&f9.getAttribute("disabled")!=null)
this.UpdateCmdBtnState(f9,false);
f9=this.GetCmdBtn(e4,"Cancel");
...
{
var ar3=this.GetTitleBar(e4);
if (ar3){
ar3.GetHeight=function (){
return document.defaultView.getComputedStyle(this,"").getPropertyValue("height");
}
ar3.SetHeight=function (value){
...
ar3.GetValue=function (){
return this.textContent;
}
ar3.SetValue=function (value){
...
var ar4=this.GetPageActiveSpread();
if (ar4!=null){
this.SaveData(ar4);
ar4.e2=false;
}
ar4=this.GetPageActiveSheetView();
if (ar4!=null){
this.SaveData(ar4);
ar4.e2=false;
}
...
var s9="";
var p8=this.GetTopSpread(e4);
var ar6=p8.getAttribute("scrollContentColumns");
var ar7=p8.getAttribute("scrollContentMaxHeight");
var ar8=p8.getAttribute("scrollContentTime");
var i6=this.GetViewport(p8);
var ar9=this.GetColGroup(i6);
var n7=this.GetParent(i6);
var as0=0;
if (hs){
var as1=n7.scrollLeft;
var c6=this.GetColHeader(p8);
var u6=0;
for (;u6<ar9.childNodes.length;u6++){
var h3=ar9.childNodes[u6];
as0+=h3.offsetWidth;
if (as0>as1)break ;
}
var as2=this.GetViewport2(p8);
if (as2)u6+=this.GetColGroup(as2).childNodes.length;
if (c6){
...
var as3=this.GetHeaderCellFromRowCol(p8,u0,u6,true);
if (as3){
if (as3.getAttribute("FpCellType")=="ExtenderCellType"&&as3.getElementsByTagName("DIV").length>0){
var z9=this.GetEditor(as3);
var aa0=this.GetFunction("ExtenderCellType_getEditorValue");
if (z9!==null&&aa0!==null){
s9="&nbsp;Column:&nbsp;"+aa0(z9)+"&nbsp;";
}
...
var as4=0;
var as5=2;
for (var ab0=0;ab0<i6.rows.length;ab0++){
var h1=i6.rows[ab0];
as0+=h1.offsetHeight;
if (as0>o4){
...
var as2=this.GetViewport1(p8);
if (as2)u0+=as2.rows.length;
if (e4.getAttribute("LayoutMode")==null&&ar6!=null&&ar6.length>0){
as4=as4>ar7?ar7:as4;
var as6=ar6.split(",");
var as7=false;
for (var f1=0;f1<as6.length;f1++){
var h3=parseInt(as6[f1]);
...
var as8=(h4.getAttribute("group")==1);
var af4=(h4.parentNode.getAttribute("previewrow")!=null);
var g3=(h4.getAttribute("RowEditTemplate")!=null);
var j9=this.IsXHTML(e4);
if (!j9&&ar5==""){
this.GetScrollingContentStyle(e4);
if (am8!=null){
if (am8.fontFamily!=null&&am8.fontFamily!="")ar5+="fontFamily:"+am8.fontFamily+";";
if (am8.fontSize!=null&&am8.fontSize!="")ar5+="fontSize:"+am8.fontSize+";";
if (am8.fontStyle!=null&&am8.fontStyle!="")ar5+="fontStyle:"+am8.fontStyle+";";
if (am8.fontVariant!=null&&am8.fontVariant!="")ar5+="fontVariant:"+am8.fontVariant+";";
if (am8.fontWeight!=null&&am8.fontWeight!="")ar5+="fontWeight:"+am8.fontWeight+";";
if (am8.backgroundColor!=null&&am8.backgroundColor!="")ar5+="backgroundColor:"+am8.backgroundColor+";";
if (am8.color!=null&&am8.color!="")ar5+="color:"+am8.color;
}
}
if (!as7){
s9+="<div style='overflow:hidden;height:"+as4+"px;ScrollingContentWidth'><table cellPadding='0' cellSpacing='0' style='height:"+as4+"px;"+(as8?"":"table-layout:auto;")+ar5+"'><tr>";
}
s9+="<td style='width:"+(as8?0:h4.offsetWidth)+"px;'>";
as5+=h4.offsetWidth;
if (as8)
...
var as9=this.parseCell(e4,h4);
s9+="&nbsp;<i>RowEditTemplate:</i>&nbsp;"+as9+"&nbsp;"
}
else {
...
if (as7){
s9=s9.replace("ScrollingContentWidth"," width:"+as5+"px;");
s9+="</tr></table></div>";
}
}
if (s9.length<=0&&c5){
...
var as3=this.GetHeaderCellFromRowCol(e4,i9,u6,false);
if (as3)s9="&nbsp;Row:&nbsp;"+as3.textContent+"&nbsp;";
}
if (s9.length<=0){
...
this.ShowMessageInner(p8,s9,(hs?-1:-2),(hs?-2:-1),ar8);
}
...
var at1=p8.id;
if (s9.length>0){
s9=s9.replace(new RegExp("=\""+at1,"g"),"=\""+at1+"src");
s9=s9.replace(new RegExp("name="+at1,"g"),"name="+at1+"src");
}
return s9;
}
...
for (var f1=0;f1<f0;f1++){
var at2=document.styleSheets[f1];
for (var i1=0;i1<at2.cssRules.length;i1++){
var at3=at2.cssRules[i1];
if (at3.selectorText=="."+e4.id+"scrollContentStyle"){
am8=at3.style;
break ;
}
}
...
if (h4==null)return ;
var at4=h4.getElementsByTagName("SELECT");
...
var at4=j2.getElementsByTagName("SELECT");
if (at4!=null&&at4.length>0){
return at4[0].value;
}
...
var at5=x8.getAttribute("groupchar");
if (at5==null)at5=",";
var w5=v9.length;
while (true){
v9=v9.replace(at5,"");
...
var at6=x8.getAttribute("negsign");
if (at6==null)at6="-";
v9=at6+v9.substring(1,v9.length-1);
}
...
var as0=h4;
var at7=h4.getAttribute("FpRef");
if (at7!=null)as0=document.getElementById(at7);
var at6=as0.getAttribute("negsign");
var z0=as0.getAttribute("possign");
if (at6!=null)x4=x4.replace(at6,"-");
...
if (p4)p4=!isNaN(x4);
if (p4){
var x1=as0.getAttribute("MinimumValue");
var j1=as0.getAttribute("MaximumValue");
var x0=parseInt(x4);
if (x1!=null){
x1=parseInt(x1);
p4=(!isNaN(x1)&&x0>=x1);
...
if (!p4){
if (as0.getAttribute("error")!=null)
return as0.getAttribute("error");
else 
return "Integer";
}
return "";
...
if (x4==null||x4.length==0)return "";
var as0=h4;
if (h4.getAttribute("FpRef")!=null)as0=document.getElementById(h4.getAttribute("FpRef"));
var at8=as0.getAttribute("decimalchar");
if (at8==null)at8=".";
var at5=as0.getAttribute("groupchar");
if (at5==null)at5=",";
x4=the_fpSpread.Trim(x4);
var p4=true;
p4=(x4.length==0||x4.charAt(0)!=at5);
if (p4){
var f0=x4.indexOf(at8);
if (f0>=0){
f0=x4.indexOf(at5,f0);
p4=(f0<0);
}
}
if (p4){
...
var x1=as0.getAttribute("MinimumValue");
var j1=as0.getAttribute("MaximumValue");
p4=the_fpSpread.IsDouble(x4,at8,at6,z0,x1,j1);
}
if (!p4){
if (as0.getAttribute("error")!=null)
return as0.getAttribute("error");
...
var as0=h4;
if (h4.getAttribute("FpRef")!=null)as0=document.getElementById(h4.getAttribute("FpRef"));
var w4=as0.getAttribute("currencychar");
if (w4==null)w4="$";
x4=x4.replace(w4,"");
var at5=as0.getAttribute("groupchar");
if (at5==null)at5=",";
...
if (w4!=null){
var at9=document.createElement("SPAN");
at9.innerHTML=w4;
w4=at9.innerHTML;
}
if (w4==null)w4="$";
...
var as0=h4;
if (h4.getAttribute("FpRef")!=null)as0=document.getElementById(h4.getAttribute("FpRef"));
var au0=new RegExp(as0.getAttribute("fpexpression"));
var w8=x4.match(au0);
...
var as0=h4;
if (h4.getAttribute("FpRef")!=null)as0=document.getElementById(h4.getAttribute("FpRef"));
var au1=as0.getAttribute("percentchar");
if (au1==null)au1="%";
g0=g0.replace(au1,"");
var at5=as0.getAttribute("groupchar");
if (at5==null)at5=",";
...
x8=g0;
if (x4!=null&&x4!=""){
var as0=the_fpSpread.GetCell(x8);
if (as0.getAttribute("FpRef")!=null)as0=document.getElementById(as0.getAttribute("FpRef"));
var au1=as0.getAttribute("percentchar");
if (au1==null)au1="%";
x4=x4.replace(" ","");
x4=x4.replace(au1,"");
...
if (x4!=null){
var as0=the_fpSpread.GetCell(h4);
if (as0.getAttribute("FpRef")!=null)as0=document.getElementById(as0.getAttribute("FpRef"));
var au1=as0.getAttribute("percentchar");
if (au1==null)au1="%";
x4=x4.replace(au1,"");
...
var p4=!isNaN(x4);
if (p4){
var au3=as0.getAttribute("MinimumValue");
var au4=as0.getAttribute("MaximumValue");
if (au3!=null||au4!=null){
var x1=parseFloat(au3);
var j1=parseFloat(au4);
p4=!isNaN(x1)&&!isNaN(j1);
if (p4){
if (at8==null)at8=".";
p4=the_fpSpread.IsDouble(au2,at8,at6,z0,x1*100,j1*100);
}
}
}
if (!p4){
...
{
var au5=h4;
while (au5.firstChild!=null)au5=au5.firstChild;
var as0=au5.nodeValue;
return as0;
}
}
}
...
for (var f1=0;f1<au6.length;f1++){
if (au6[f1].tagName=="INPUT"&&au6[f1].checked){
return au6[f1].value;
}
}
return "";
...
var au6=h4.getElementsByTagName("INPUT");
for (var f1=0;f1<au6.length;f1++){
if (au6[f1].tagName=="INPUT"&&x4==the_fpSpread.Trim(au6[f1].value)){
au6[f1].checked=true;
break ;
}else {
if (au6[f1].checked)au6[f1].checked=false;
}
}
}
...
var h4=the_fpSpread.GetCell(x8,true);
if (h4==null)return ;
var at4=h4.getElementsByTagName("DIV");
if (at4!=null&&at4.length>0){
...
var at4=j2.getElementsByTagName("DIV");
if (at4!=null&&at4.length>0){
var au7=j2.getElementsByTagName("input");
if (au7!=null&&au7.length>0)
return au7[0].value;
return ;
}
...
a8=the_fpSpread.GetCellEditor(e4,w0,true);
if (a8!=null){
var au8=a8.getAttribute("MccbId");
if (au8){
FarPoint.System.WebControl.MultiColumnComboBoxCellType.CheckInit(au8);
var ai7=eval(au8+"_Obj");
if (ai7!=null&&ai7.SetText!=null){
ai7.SetText(v9);
return v9;
}
}
...
var h4=the_fpSpread.GetCell(x8,true);
if (h4==null)return ;
var au9=h4.getElementsByTagName("INPUT");
if (au9!=null&&au9.length>0){
var g0=au9[0];
return g0.value;
}
return null;
...
if (h4==null)return ;
var av0=h4.getElementsByTagName("DIV");
if (av0!=null&&av0.length>0){
var au8=av0[0].getAttribute("MccbId");
if (au8){
var ai7=eval(au8+"_Obj");
if (ai7!=null&&typeof(ai7.FocusForEdit)!="undefined"){
ai7.FocusForEdit();
}
}
}
